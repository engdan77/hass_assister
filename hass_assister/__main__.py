...
default_config = {
    ...
    "mqtt_replacement": {
        "initial": {
            ...
            ("solna_bedroom_light/state", "on"): ("cmnd/solnarf/Backlog", "rfraw AAB04E050801540A0000BE04BA276001020302030302020303020302030202030203030202030302030203020203030002030302020303020203020303020203030202030203030202030203030202030455 ; rfraw 177"),
            ("solna_bedroom_light/state", "off"): ("cmnd/solnarf/Backlog", "rfraw AAB04E050801400A0A00B404BA275601020302030302020303020302030202030203030202030302030003000203030002030300020303000203000303000003030000030003000300030003030000030455 ; rfraw 177"),
            ("tele/solnarf/RESULT", ".*?AA B0 4E 0508 0154 0A00 00BE04BA2760010203020303020203030203020302020302030302020303020302030202030300020303020203030202030203030202030302020302030302020302030302020304 55.*"): ("solna_bedroom_light/state", "on"),
            ("tele/solnarf/RESULT", ".*?AA B0 4E 0508 0140 0A0A 00B404BA2756010203020303020203030203020302020302030302020303020300030002030300020303000203030002030003030000030300000300030003000300030300000304 55.*"): ("solna_bedroom_light/state", "off"),
            ("solna_livingroom_light/state", "on"): ("cmnd/solnarf/Backlog", "rfraw AAB04E050801540A2804C400BE27B001030202030302030202030302020303020302030202030203030203020302020003020302030202030302030202030302020303020302020002000302020000020455 ; rfraw 177"),
            ("solna_livingroom_light/state", "off"): ("cmnd/solnarf/Backlog", "rfraw AAB04E050801540A1E00BE04C427C401020303020203020303020203030202030203020303020302020302030203030202030203020303020203020303020203030202030203020303020203030202030455 ; rfraw 177"),
            ("tele/solnarf/RESULT", ".*?AA B0 4E 0508 0154 0A28 04C400BE27B0010302020303020302020303020203030203020302020302030302030203020200030203020302020303020302020303020203030203020200020003020200000204 55.*"): ("solna_livingroom_light/state", "on"),
            ("tele/solnarf/RESULT", ".*?AA B0 4E 0508 0154 0A1E 00BE04C427C4010203030202030203030202030302020302030203030203020203020302030302020302030203030202030203030202030302020302030203030202030302020304 55.*"): ("solna_livingroom_light/state", "off"),
        }
    },
}
